...
QT_MOC_LITERAL(1, 16, 22), // "connectionUpdateSignal"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 6) // "status"

    },
    "CommandReceiver\0connectionUpdateSignal\0"
    "\0status"
};
...
void CommandReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->connectionUpdateSignal((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CommandReceiver::connectionUpdateSignal)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void CommandReceiver::connectionUpdateSignal(bool _t1)
{
