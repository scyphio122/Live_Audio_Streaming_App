...
QT_MOC_LITERAL(3, 41, 6), // "hostIP"
QT_MOC_LITERAL(4, 48, 25), // "connectionEstablishSignal"
QT_MOC_LITERAL(5, 74, 2), // "ip"
QT_MOC_LITERAL(6, 77, 4), // "port"
QT_MOC_LITERAL(7, 82, 22), // "connectionStatusUpdate"
QT_MOC_LITERAL(8, 105, 11), // "isConnected"
QT_MOC_LITERAL(9, 117, 21), // "disconnectGUICallback"
QT_MOC_LITERAL(10, 139, 27), // "connectionUpdateGUICallback"
QT_MOC_LITERAL(11, 167, 21) // "connectionEstablished"

    },
    "CommandReceiver\0connectionRequestSignal\0"
    "\0hostIP\0connectionEstablishSignal\0ip\0"
    "port\0connectionStatusUpdate\0isConnected\0"
    "disconnectGUICallback\0connectionUpdateGUICallback\0"
...
void CommandReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->connectionRequestSignal((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->connectionEstablishSignal((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->connectionStatusUpdate((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->disconnectGUICallback(); break;
        case 4: _t->connectionUpdateGUICallback((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (CommandReceiver::*_t)(QString );
        ...
        {
            typedef void (CommandReceiver::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CommandReceiver::connectionStatusUpdate)) {
                *result = 2;
            }
        }
        {
            typedef void (CommandReceiver::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CommandReceiver::disconnectGUICallback)) {
                *result = 3;
            }
        }
    }
...
// SIGNAL 0
void CommandReceiver::connectionRequestSignal(QString _t1)
{
...
// SIGNAL 2
void CommandReceiver::connectionStatusUpdate(bool _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 3
void CommandReceiver::disconnectGUICallback()
{
